...
It was developed as part of my MSc thesis in Mathematical Engineering, to extend the powerful methods of conformal prediction for regression to the multivariate response case.
